...
for nd = 1:numel(fdir)%95
    ...
    % count the number of whales within 500 m of eachother
...
title('Total number of whales in encounter')
xlabel('Number of whales')
ylabel('number of occurances')
ylim([0, 50])

subplot(1,2,2)
histogram(simultaneousCount,  [0.5:7.5])
title('Max Number of whales vocalizing concurrently in an encounter')
xlabel('Number of whales')
ylabel('number of occurances')
ylim([0, 50])