...
for i = 1:length(df)
   ...
   for wn = 1:numCols
       ...
       elseif minDepth > 800 && deltaDepth < 100
           z_stats(6,wn) = 2; % assign dive type 2
       elseif minDepth > 800 && deltaDepth > 100 && deltaDepth < 350
